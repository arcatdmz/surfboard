...
public class SurfboardTest implements SurfingListener {
	...
	public void onSurfingGesture(boolean isSurfedToLeft) {
		if (isShiftPressed) {
			if (isSurfedToLeft) {
				panels[p.getSelectedIndex()].zoomIn();
			} else {
				panels[p.getSelectedIndex()].zoomOut();
			}
		} else {
